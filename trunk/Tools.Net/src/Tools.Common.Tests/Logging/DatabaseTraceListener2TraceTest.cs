...
namespace Tools.Common.UnitTests
{
    ...
    ///</summary>
    [TestClass()]
    public class DatabaseTraceListener2TraceTest
    {
        ...
        public void MyTestInitialize()
        {
            ...
            databaseListener = new DatabaseTraceListener2(storedProcedureName, logConnectionStringName,
                null, null);

            Trace.Listeners.Add(databaseListener);
        ...
        {
            Assert.IsTrue(Trace.Listeners.Contains(databaseListener));

            Trace.WriteLine("Test of Trace.WriteLine");
            Trace.Write("Test of Trace.Write");
            // TraceWarning
            Trace.TraceWarning("Test of Trace.TraceWarning(message)");
            Trace.TraceWarning(
                "Test of Trace.TraceWarning(message, params string[] args) [{0}]", "test");
            // TraceInformation
            Trace.TraceInformation("Test of Trace.TraceInformation(message)");
            Trace.TraceInformation(
                "Test of Trace.TraceInformation(message, params string[] args) [{0}]", "test");
            // TraceError
