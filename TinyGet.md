...
Microsoft TinyGet utility is part of the IIS 6 ResourceKit. As of this moment I was not able to find IIS 7 Resource Kit, and IIS 6 Resource kit declines to install on Windows Vista Home Premium Edition I have, so I had to copy the tinyget from the Resource kit installed on the W2003.
...
http://www.robertbeal.info/archives/30
http://code.msdn.microsoft.com/AsyncMvc/Wiki/View.aspx?id=11350 (also shows how to measure execution time with Powershell's Measure-Command cmdlet):
```
...
# Using tinyget to replay http traffic and validate results #

http://technet.microsoft.com/en-us/library/cc656685.aspx

# Http record&replay alternatives #
http://blogs.msdn.com/drnick/archive/2009/04/13/debugging-http-with-replay.aspx
