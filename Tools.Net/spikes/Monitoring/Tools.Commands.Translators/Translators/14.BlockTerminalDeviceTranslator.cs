...
namespace Tools.Commands.Translators
{
    public class BlockTerminalDeviceTranslator : TranslatorBase
    {
        ...
        public BlockTerminalDeviceTranslator()
        {
            ...
            Schemas.Add("http://www.tibco.com/schemas/SDPRO_Observer/Observer/SharedResources/XSD/IF1/BlockTerminalDevice.xsd", AppDomain.CurrentDomain.BaseDirectory + @"\IF1\xsd\BlockTerminalDevice.xsd");
        }
