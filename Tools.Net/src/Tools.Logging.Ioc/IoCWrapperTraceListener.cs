...
namespace Tools.Logging.Ioc
{
    ...
    public class IocWrapperTraceListener : TraceListener
    {
        ...
        [SuppressMessage("Microsoft.Design", "CA1031:DoNotCatchGeneralExceptionTypes", Justification="This method is supposed to be highly fault tolerant and report any exception that happened during its execution to the fallback logger.")]
