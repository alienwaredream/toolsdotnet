...
namespace Tools.Failover
{
    ...
    /// </summary>
    [Serializable]
    public class FailoverConfiguration : Descriptor, IEnabled
    {
        #region Fields
        ...
        private FailoverRetryRule _failoverRetryRule = FailoverRetryRule.DefaultRule;
        ...
        public FailoverRetryRule FailoverRetryRule
        {
            get { return _failoverRetryRule; }
            set { _failoverRetryRule = value; }
        }
