...
namespace Tools.Core.Asserts
{
    ...
    public static class ErrorTrap
    {
        ...
        #region Fields
        [ThreadStatic()]
        private static List<Tools.Core.Messaging.Message> messages = new List<Tools.Core.Messaging.Message>();
        [ThreadStatic()]
        ...
        public static List<Tools.Core.Messaging.Message> Messages
        {
            get
            {
                if (messages != null)
                ...
                return messages = new List<Tools.Core.Messaging.Message>();
            }
            set
            {
                messages = value;
            ...
            )
        {
            ...
            Tools.Core.Messaging.Message message = new Tools.Core.Messaging.Message
                (Convert.ToInt32(messageId), messageId.ToString(), text,
                Tools.Core.Messaging.MessageType.None);
