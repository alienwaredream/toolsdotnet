...
namespace Tools.Tracing.UI
{
	...
	/// </summary>
	public class ApplicationEventFilterControl : System.Windows.Forms.UserControl
	{
		private System.Windows.Forms.Panel panel1;
		private System.Windows.Forms.Splitter filterSplitter;
		...
		private System.Windows.Forms.TextBox altActiveTextBox;
		...
		private System.Windows.Forms.MenuItem loadFromFileMenuItem;
		private System.Windows.Forms.MenuItem saveToFileMenuItem;
		private System.Windows.Forms.MenuItem menuItem3;
		private System.Windows.Forms.MenuItem loadFromClipboardMenuItem;
		private System.Windows.Forms.MenuItem copyToClipboardMenuItem;
		private FilterViewControl filterView = null;
		...
		public ApplicationEventFilter Filter
		{
			...
			{
				_filter = value;
				createTreeView(this.filterTreeView, _filter);
			}
		}
		...
		public ApplicationEventFilterControl()
		{
			...
			filterTreeView.ImageList = this.filterImageList;	

			createTreeView(filterTreeView, null);

			filterTreeView.KeyDown +=new KeyEventHandler(filterTreeView_KeyDown);
			filterTreeView.KeyUp +=new KeyEventHandler(filterTreeView_KeyUp);

			//filter view
			filterView = new FilterViewControl();
			filterView.Left = 	this.filterSplitter.Right;
			filterView.Height = this.filterPropertyGrid.Top;
			filterView.Width = this.Width - this.filterSplitter.Width - this.filterTreeView.Width;
			filterView.Top = 0;
		...
		private void createTreeView(TreeView treeview, ApplicationEventFilter sourceFilter)
		{
			...
			TreeNode node = new TreeNode(typeof(TraceEvent).Name);	
			node.ImageIndex = 4;
			...
			ApplicationEventFilter sourceFilter)
		{
			...
			{
				TreeNode childNode = new TreeNode(pi.Name);
				
				propertyPath = pathRoot;

				if (!pi.PropertyType.IsValueType&&pi.PropertyType != typeof(String)&&pi.PropertyType != typeof(object))
				{
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(ApplicationEventFilterControl));
			...
			this.filterSplitter.SplitterMoved += new System.Windows.Forms.SplitterEventHandler(this.filterSplitter_SplitterMoved);
			// 
			// filterTreeView
			// 
			...
			// filterPropertyGrid
			// 
			this.filterPropertyGrid.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left) 
				| System.Windows.Forms.AnchorStyles.Right)));
			...
			// altActiveTextBox
			// 
			this.altActiveTextBox.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left)));
		...
		private void filterPropertyGrid_Click(object sender, System.EventArgs e)
		{
		
		}

		private void filterSplitter_SplitterMoved(object sender, System.Windows.Forms.SplitterEventArgs e)
		{
			// TODO: Introduce a container for those onto this control
			this.filterPropertyGrid.Width = this.Width - this.filterTreeView.Width - 3;
			this.filterPropertyGrid.Left = this.filterSplitter.Right;
			filterView.Width = this.Width - this.filterTreeView.Width - 3;
			filterView.Left = this.filterSplitter.Right;
		}

		private void filterTreeView_AfterSelect(object sender, System.Windows.Forms.TreeViewEventArgs e)
		{
			this.filterPropertyGrid.SelectedObject = e.Node.Tag;
		}
		...
		private void filterTreeView_KeyDown(object sender, KeyEventArgs e)
		{
			...
			altActiveTextBox.Text += " " + e.KeyCode.ToString();		
		...
		{
			TreeNode node = this.filterTreeView.SelectedNode;
			if (node==null) return;
			object o = node.Tag;
			if (o==null) return;
			IEnabled e = o as IEnabled;
			if (o==null) return;
			e.Enabled = enabled;
			this.filterPropertyGrid.SelectedObject = node.Tag;
			if (enabled)
			{
				node.ImageIndex = 2;
			}
		...
		{
			this.altActiveTextBox.Text = String.Empty;
		}
		...
		private void saveToFileMenuItem_Click(object sender, System.EventArgs e)
		{
		...
		private void loadFromFileMenuItem_Click(object sender, System.EventArgs e)
		{
