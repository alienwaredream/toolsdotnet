...
#region Class RemotingClient
	...
	public abstract class RemotingClient
	{
		...
		/// TODO:
		/// </summary>
		protected static bool _tcpClientChannelRegistered = false;
		//
		private string	_serviceHost	= null;
		private int		_servicePort	= 0;
		private string	_objectUriPath	= null;
		...
		protected void registerTcpClientChannel( )
		{
			...
			TcpClientChannel tcpChannel = new TcpClientChannel( String.Empty, sinkProvider );
