...
namespace Tools.Tracing.Common
{
    ...
    public class TraceEventHandlerConfigurationCollection : CollectionBase
    {
        ...
        {
            get { return ((TraceEventHandlerConfiguration) (List[index])); }
        ...
        public void AddRange(TraceEventHandlerConfiguration[] value)
        {
            ...
            {
                TraceEventHandlerConfiguration nv = GetEntry(value[i].Name);
                if (nv != null)
                {
                    nv = value[i];
                }
        ...
        {
            ApplicationEventHandlerConfigurationEnumerator ce = GetEnumerator();
            while (ce.MoveNext())
            {
        ...
        public class ApplicationEventHandlerConfigurationEnumerator : object, IEnumerator
        {
            ...
            {
                get { return ((TraceEventHandlerConfiguration) (baseEnumerator.Current)); }
            }
